...
logevalMr2a8 = np.clip(np.log10(np.abs(evalMr2a8.real)),0,100)*np.sign(evalMr2a8.real)
logevalMr3a9 = np.clip(np.log10(np.abs(evalMr3a9.real)),0,100)*np.sign(evalMr3a9.real)
logevalMr4a1 = np.clip(np.log10(np.abs(evalMr4a1.real)),0,100)*np.sign(evalMr4a1.real)
